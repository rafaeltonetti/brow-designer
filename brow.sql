...
--
-- Host: 127.0.0.1
-- Tempo de geração: 15/09/2025 às 04:30
...
--
ALTER TABLE `aulas_concluidas`
  ADD CONSTRAINT `aulas_concluidas_ibfk_1` FOREIGN KEY (`aula_id`) REFERENCES `aulas` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `aulas_concluidas_ibfk_2` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE;
